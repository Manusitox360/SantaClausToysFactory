<header class="sticky top-0 bg-candy-cane p-4 z-20">
    <nav class="bg-no-repeat bg-cover bg-inherit">
        <div class="flex justify-between items-center px-4 max-w-full w-full">
            ...
            <div class="flex justify-center space-x-12 items-center">
                <nav class="flex justify-start space-x-12 items-center">
            ...
            @if (request()->routeIs('santa'))
                <button class="transition hover:scale-110 duration-500 font-bold bg-[#530402] rounded py-2">
