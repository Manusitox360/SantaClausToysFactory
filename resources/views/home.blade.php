...
@section('content')
<section class="flex flex-col items-center justify-center overflow-auto xl:h-[829px]">
    <div class="flex justify-center items-center flex-col text-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-10 sm:gap-24 py-4 h-full ">
            <a href="{{ route('santa') }}">
        ...
        <div class="flex flex-wrap items-center justify-center gap-10 sm:gap-24 py-5 h-full">
