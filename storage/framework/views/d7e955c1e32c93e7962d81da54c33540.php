<header class="sticky top-0 bg-candy-cane p-4 z-20">
    <nav class="bg-no-repeat bg-cover bg-inherit">
        <div class="flex flex-col sm:flex-row justify-between items-center px-4 max-w-full w-full">
            <button>
                <a href="<?php echo e(route('home')); ?>" class="flex justify-center items-center bg-[#530402] rounded py-1 px-2 transform hover:scale-110 transition-transform">
                    <img src="<?php echo e(asset('img/logoHeader.png')); ?>" class="h-6 pr-1 sm:mr-3 sm:h-9" alt="Flowbite Logo" />
            ...
            <div class="flex justify-center items-center">
                <nav class="flex justify-start space-x-2 py-2 sm:py-0 sm:space-x-12 items-center">
                    <a href="<?php echo e(route('santa')); ?>" class="bg-[#530402] text-white hover:text-[#8b191d] transition rounded p-1 py-[0.4rem] transform hover:scale-110 transition-transform">
                    ...
                    <a href="<?php echo e(route('elf')); ?>" class="bg-[#530402] text-white hover:text-green-700 transition rounded p-1 py-[0.4rem] transform hover:scale-110 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512" class="w-8 h-6">
            ...
            <?php if(request()->routeIs('santa')): ?>
                <button class="transition hover:scale-110 duration-500 font-bold bg-[#530402] rounded py-1 sm:py-2">
                    <a class="font-semibold whitespace-nowrap text-white p-2 sm:p-4 text-base sm:text-xl" href="<?php echo e(route('santaGifts')); ?>">🎁Give Gifts🎁</a>
                </button>
            <?php else: ?>
                <div class="oppacity-0">
                    <div class="text-xl font-semibold whitespace-nowrap text-white px-[5rem] text-transparent" href=""></div>
                </div>
            <?php endif; ?>
        </div>
    </nav>
</header>
<?php /**PATH C:\xampp\htdocs\Github\SantaClausToysFactory\resources\views/components/header.blade.php ENDPATH**/ ?>